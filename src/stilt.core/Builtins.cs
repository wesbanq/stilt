...
namespace stilt
{
	...
	public static class Builtins
	{
		...
		public static readonly TypeSymbol Whole = new("whole", Symbol.BuiltinSource, inherits: [SymbolReference.AlreadyResolved(Num)]);
		public static readonly TypeSymbol Fractional = new("fract", Symbol.BuiltinSource, inherits: [SymbolReference.AlreadyResolved(Num)]);
		public static readonly TypeSymbol Byte = new("byte", Symbol.BuiltinSource, inherits: [SymbolReference.AlreadyResolved(Whole)]);
		public static readonly TypeSymbol Short = new("short", Symbol.BuiltinSource, inherits: [SymbolReference.AlreadyResolved(Whole)]);
		public static readonly TypeSymbol Int = new("int", Symbol.BuiltinSource, inherits : [SymbolReference.AlreadyResolved(Whole)]);
		public static readonly TypeSymbol Long = new("long", Symbol.BuiltinSource, inherits : [SymbolReference.AlreadyResolved(Whole)]);
		public static readonly TypeSymbol Float = new("float", Symbol.BuiltinSource, inherits : [SymbolReference.AlreadyResolved(Fractional)]);
		public static readonly TypeSymbol Double = new("double", Symbol.BuiltinSource, inherits : [SymbolReference.AlreadyResolved(Fractional)]);
